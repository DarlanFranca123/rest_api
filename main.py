...
def get_destionation(destination_id):
...
def update_destionation(destination_id):
    data = request.get_json(destination_id)
...
def delete_destination(destination_id):
    ...
    if destination:
        ...
        return jsonify({"message" : f"destination was deleted"})
    else: 
        return jsonify({"error": "Destination not found"}), 404
